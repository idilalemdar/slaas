...
DIR1 = "experimentResults/firstExperimentBatch"
DIR2 = "experimentResults/secondExperimentBatch"
...
if __name__ == '__main__':
    ...
    plt.legend()
    plt.title("Population fitness vs Generation with λ1 = 0.5, λ2 = 2, μ1 = 2, μ2 = 10")
    plt.xlabel("Generations")
    plt.ylabel("Average population fitness (normalized)")
    plt.savefig("report/plot1.png")
